  ...
  <tr className="animate-pulse">
    <td className="px-6 py-4">
      <div className="flex items-center">
        <div className="h-12 w-12 bg-slate-700/50 rounded-xl mr-4 flex-shrink-0"></div>
        <div>
    ...
    <td className="px-6 py-4"><div className="h-6 bg-slate-700/50 rounded-full w-24"></div></td>
